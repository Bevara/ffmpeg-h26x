...
const GF_FilterRegister * EMSCRIPTEN_KEEPALIVE rfh263_register(GF_FilterSession *session)
{
...
void register_rfh263(void) {
    gf_filter_auto_register("rfh263", rfh263_register);
}
