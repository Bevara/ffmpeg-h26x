...
const GF_FilterRegister * EMSCRIPTEN_KEEPALIVE ffdec_h26x_register(GF_FilterSession *session)
{
...
const GF_FilterRegister *ffdec_h26x_register(GF_FilterSession *session)
{
	return NULL;
}
#endif
...
void register_ffdec_h26x(void) {
    gf_filter_auto_register("ffdec_h26x", ffdec_h26x_register);
}
